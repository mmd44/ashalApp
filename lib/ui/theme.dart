...
class Colors {
  ...
  static const Color appBarGradientStart = const Color(0xFFE30D18);
  static const Color appBarGradientEnd = const Color(0xFFE30D18);

  //static const Color itemCard = const Color(0xFF434273);
  static const Color itemCard = const Color(0xFFE30D18);
  ...
  static const Color cardLocation = const Color(0xFFFFFFFF);
