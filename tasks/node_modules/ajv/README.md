...
Ajv treats JSON schemas as trusted as your application code. This security ui.model is based on the most common use case, when the schemas are static and bundled together with the application.
